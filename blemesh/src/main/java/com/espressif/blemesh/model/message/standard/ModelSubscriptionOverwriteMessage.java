...
public class ModelSubscriptionOverwriteMessage extends MeshMessage {
    private Model mModel;
    private long mSubAddress;

    public ModelSubscriptionOverwriteMessage(Node node, Model model, long subAddr) {
    ...
    public byte[] getOpCode() {
        return new byte[]{(byte) 0x80, 0x1E};
    }
